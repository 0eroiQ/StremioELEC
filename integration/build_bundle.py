...
def main():
    ...
    sources = {'skin.bingie': root, 'plugin.video.stremioelec': root / 'integration/plugin.video.stremioelec'}
            ...
            with zipfile.ZipFile(dest, 'w', zipfile.ZIP_DEFLATED) as archive:
                for path in sorted(sources[identity].rglob('*')):
                    ...
                    if path.is_file() and not any(part.startswith('.') or part == '__pycache__'
                        ...
                        if identity == 'skin.bingie' and relative.parts[0] in ('integration', 'README.md'):
                            continue
    ...
    (args.output / 'INSTALL.md').write_text(
        ...
        'skin.bingie: this replaces an existing Bingie installation. '
